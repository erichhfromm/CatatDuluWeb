      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-between p-8">
        ...
        >
          ...
          <p className="text-lg text-white/80 max-w-md">
            Data keuangan Anda dilindungi dengan enkripsi tingkat bank dan autentikasi berlapis
          </p>
        </motion.div>
        ...
        <div className="w-full space-y-4">
          ...
          <button
            ...
            className="w-full text-white/60 hover:text-white/80 transition-colors font-medium text-sm"
          >
            Kembali
          </button>
        </div>
