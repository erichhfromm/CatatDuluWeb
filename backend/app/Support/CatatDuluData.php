...
final class CatatDuluData
{
    public static function all(): array
    {
        return [
            ...
            'expenseByCategory' => self::expenseByCategory(),
    ...
    private static function monthlyTrend(): array
    {
        return [
    ...
    private static function expenseByCategory(): array
    {
        return [
    ...
    {
        return [
            ['id' => 'n1', 'title' => 'Budget Makanan hampir habis', 'desc' => 'Anda telah menggunakan 92% dari budget Belanja bulan ini.', 'time' => '5 menit lalu', 'read' => false, 'type' => 'warning'],
            ['id' => 'n2', 'title' => 'Pemasukan baru tercatat', 'desc' => 'Gaji bulanan sebesar Rp 12.500.000 berhasil masuk.', 'time' => '2 jam lalu', 'read' => false, 'type' => 'success'],
            ['id' => 'n3', 'title' => 'Laporan Mei siap diunduh', 'desc' => 'Laporan keuangan bulanan Anda telah selesai dirangkum.', 'time' => 'Kemarin', 'read' => true, 'type' => 'info'],
            ['id' => 'n4', 'title' => 'Pengingat tagihan listrik', 'desc' => 'Tagihan jatuh tempo dalam 3 hari (Rp 450.000).', 'time' => '2 hari lalu', 'read' => true, 'type' => 'warning'],
            ['id' => 'n5', 'title' => 'Target tabungan tercapai 60%', 'desc' => 'Anda satu langkah lebih dekat ke goal "Liburan Bali".', 'time' => '3 hari lalu', 'read' => true, 'type' => 'success'],
        ];
    }
}
